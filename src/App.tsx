...
// CookieConsentProvider removed - all cookies automatically accepted
...
function Layout({ children, session }: LayoutProps) {
  ...
  return (
    <div className={cn(
      "min-h-screen flex flex-col pb-16",
  ...
  return (
    <ThemeProvider defaultTheme="light" storageKey="zaparounds-theme">
      <HelmetProvider>
                ...
                <Layout session={session}>
                  <Suspense fallback={<LoadingFallback />}>
                    <Routes>
                      ...
                      <Route path="/:lang/browser-test" element={<BrowserTest />} />
        ...
        {/* CookieConsentProvider closing tag removed */}
      </HelmetProvider>
    </ThemeProvider>
  );
}
