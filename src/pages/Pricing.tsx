...
export default function Pricing() {
  ...
  const handleSubscribe = async (plan: string) => {
    ...
    try {
      ...
      const productId = PRODUCT_IDS[plan as keyof typeof PRODUCT_IDS]?.[isYearly ? 'yearly' : 'monthly'];
  ...
  // Handle opening the subscription management
  const handleManageSubscription = () => {
    navigate("/profile/subscription");
  };

  // Helper to get price based on plan and billing cycle
  const getPrice = (plan: string) => {
    const planPricing = PRICING[plan as keyof typeof PRICING];
    if (!planPricing) return '0.00';
    
    const price = isYearly ? planPricing.yearly : planPricing.monthly;
    return price.toFixed(2);
  };

  // Helper to get billing text
  ...
  const structuredData = {
    ...
    "offers": [
      ...
      },
      {
        "@type": "Offer",
        "name": "ZapPro",
        "description": tPricing('zappro.description'),
        "price": "9.99",
        "priceCurrency": "USD",
        "billingIncrement": "P1M"
      }
  ...
  return (
    <>
      <SEO
        ...
        description={tPricing('subtitle')}
        keywords="ZapAround pricing, travel plans, ZapTrip, ZapOut, ZapRoad, ZapPro, travel subscription, travel pricing, affordable travel planning"
                ...
                <div className="flex flex-col md:flex-row items-center justify-between gap-8">
                  <div className="flex-1 text-center md:text-left">
                    ...
                    <div className="flex items-center justify-center md:justify-start space-x-2">
                      <span className="text-4xl font-bold text-gray-900">${getPrice('zappro')}</span>
                      <span className="text-gray-500">{getBillingText()}</span>
                    </div>
                      ...
                      <Card className="relative flex flex-col h-full bg-white/90 backdrop-blur-sm border-0 rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300 overflow-visible">
                        ...
                        <div className="p-8 pt-12">
                          ...
                          <div className="text-center mb-4">
                            <span className="text-3xl font-bold text-sky-500">${getPrice('zaptrip')}</span>
                    ...
                    <div className="group relative pt-6">
                      ...
                      <Card className="relative flex flex-col h-full bg-white/90 backdrop-blur-sm border-0 rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300 overflow-visible">
                        ...
                        <div className="p-8 pt-12">
                          ...
                          <div className="text-center mb-4">
                            <span className="text-3xl font-bold text-green-500">${getPrice('zapout')}</span>
                            <span className="text-gray-500 ml-2">{getBillingText()}</span>
                          </div>
                    ...
                    <div className="group relative pt-6">
                      ...
                      <Card className="relative flex flex-col h-full bg-white/90 backdrop-blur-sm border-0 rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300 overflow-visible">
                        ...
                        <div className="p-8 pt-12">
                          ...
                          <div className="text-center mb-4">
                            <span className="text-3xl font-bold text-amber-500">${getPrice('zaproad')}</span>
                            <span className="text-gray-500 ml-2">{getBillingText()}</span>
                          </div>
              ...
              <div className="group relative">
                ...
                <Card className="relative flex flex-col h-full bg-[#fcfcfc]/80 backdrop-blur-sm border-0 rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300">
                  <div className="p-8">
                    ...
                    <div className="text-center mb-4">
                      <span className="text-3xl font-bold text-emerald-500">${getPrice('zapout')}</span>
                      <span className="text-gray-500 ml-2">{getBillingText()}</span>
                    </div>
                    {renderPlanAction('zapout')}
                  </div>
