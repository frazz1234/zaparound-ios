      ...
      <Popover>
        <PopoverTrigger asChild>
          ...
          >
            ...
            {date ? formatDateByLocale(date) : <span>{placeholder || t('validation.invalidDate')}</span>}
          </Button>
        </PopoverTrigger>
          ...
          <div className="flex gap-2 mb-2">
            <Select value={months[month]} onValueChange={handleMonthChange} disabled={disabled}>
              <SelectTrigger className="w-[140px]">
                <SelectValue placeholder={label || t('personal.birthdate')} />
              </SelectTrigger>
