  ...
  if (!session) {
    ...
    return (
      <nav
        ...
        className="fixed bottom-4 left-1/2 z-50 -translate-x-1/2 px-2 w-[95vw] max-w-md rounded-2xl shadow-xl bg-[#fcfcfc] border border-[#eaeaea] flex items-center justify-between"
